...
<div class="container">
  <span class="body-title">Contact information</span>
  <div class="spacer"></div>
  <div class="container" style="padding:0px 20px !important;">
    <span class="body-text"><strong>E-mail:</strong> officeDreamPizza@gmail.com</span><br><br>
    <span class="body-text"><strong>Phone:</strong> +40 0766DreamP!zza</span>
  </div>
  <div class="spacer"></div>
	<span class="body-title">Where are we located?</span>
	<div class="spacer"></div>
  <div id="map">
		<!-- Google Maps API -->
   <script>
